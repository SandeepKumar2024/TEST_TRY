...
function YearlyGraph({ Yearlydata }) {
    ...
    useEffect(() => {
        ...
        if (!data || !data.yearlyLabels || data.yearlyLabels.length === 0) {
        ...
        const totalSessionsData = data.yearlyLabels.map(label => {
            return data.yearlyData[label].totalSessions;
        });
          //to convert the totalSessionTime data from millisecond to hour
          const totalSessionTimeInHours = (data.yearlySessionTimeData / (1000 * 60 * 60)).toFixed(2); // Convert milliseconds to hours
            ...
            data: {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        data: Array(data.yearlyLabels.length).fill(totalSessionTimeInHours),
                        fill:false,
                        borderWidth:3,
                        borderColor: 'red ',
                        backgroundColor: 'black',
